...
class Exploresmallbusiness extends Component {
    ...
    getUser = () => {
        fetch('/api/users/showsmallbusiness')
    ...
    <button style = {{background: '#2ab7a9'}} onClick = {this.handleReality8} class="button button1">Small Businesses</button>
...
export default Exploresmallbusiness;    