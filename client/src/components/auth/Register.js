...
return (
  ...
  <select style = {{display: 'block'}} name="tags" id="tags" onChange = {this.onChange}>
    <option value="Youtubers">Youtubers</option>
    <option value="Reality TV">Reality TV</option>
    <option value="Bloggers">Bloggers</option>
    <option value="Microinfluencers">Microinfluencers</option>
    <option value="Beauty">Beauty</option>
    <option value="Lifestyle">Lifestyle</option>
    <option value="Fashion">Fashion</option>
    <option value="Small Businesses">Small Businesses</option>
    <option value="Food">Food</option>
    <option value="Sustainable Businesses">Sustainable Businesses</option>
