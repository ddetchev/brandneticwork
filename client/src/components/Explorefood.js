...
class Explorefood extends Component {
    ...
    <button style = {{background: '#2ab7a9'}} onClick = {this.handleReality9} class="button button1">Food</button>
