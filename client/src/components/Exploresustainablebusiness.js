...
class Exploresustainablebusiness extends Component {
    ...
    getUser = () => {
        fetch('/api/users/showsustainablebusiness')
    ...
    <button style = {{background: '#2ab7a9'}} onClick = {this.handleReality10} class="button button1">Sustainable Businesses</button>
    <button onClick = {this.handleReality11} class="button button1">Travel</button>
    <button onClick = {this.handleReality12} class="button button1">Fitness</button>
    <p></p>
...
export default Exploresustainablebusiness;    