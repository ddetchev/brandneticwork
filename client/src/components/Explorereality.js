...
class Explorereality extends Component {
    ...
    <p></p>
    <button style = {{background: '#2ab7a9'}} onClick = {this.handleReality} class="button button1">Reality TV</button>
