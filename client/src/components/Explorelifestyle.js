...
class Explorelifestyle extends Component {
    ...
    <button style = {{background: '#2ab7a9'}} onClick = {this.handleReality6} class="button button1">Lifestyle</button>
...
export default Explorelifestyle;    