...
class Exploretravel extends Component {
    ...
    <button style = {{background: '#2ab7a9'}} onClick = {this.handleReality11} class="button button1">Travel</button>
