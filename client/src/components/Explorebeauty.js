...
class Explorebeauty extends Component {
    ...
    <button style = {{background: '#2ab7a9'}} onClick = {this.handleReality5} class="button button1">Beauty</button>
