...
class Exploreyoutube extends Component {
    ...
    <button style = {{background: '#2ab7a9'}} onClick = {this.handleReality2} class="button button1">Youtubers</button>
