...
class Exploremicroinfluencer extends Component {
    ...
    getUser = () => {
        fetch('/api/users/showmicroinfluencer')
    ...
    <button style = {{background: '#2ab7a9'}} onClick = {this.handleReality4} class="button button1">Microinfluencers</button>
...
export default Exploremicroinfluencer;    