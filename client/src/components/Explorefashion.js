...
class Explorefashion extends Component {
    ...
    <button style = {{background: '#2ab7a9'}} onClick = {this.handleReality7} class="button button1">Fashion</button>
